...
## Instructions
Load the [Session10PimaDiabetesCleanRand.csv](https://github.com/gwcbi/ResearchAnalytics/tree/master/ProblemSets/PS10/Session10PimaDiabetesCleanRand.csv) available from the PS10 folder.  This is a cleaned up version of the data from session 5 with 725 individuals, 7 independent/predictor variables and Diabetes is a binary response variable (1=diabetes, 0=no diabetes).
...
Save your report as a PDF file and submit your report through the course 2GW site. Clean up your code (R script) and submit it as a supplementary file, along with your main report.
